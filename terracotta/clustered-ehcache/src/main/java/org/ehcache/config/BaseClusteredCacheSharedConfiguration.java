 ...
 * @author Alex Snaps
 */
public class BaseClusteredCacheSharedConfiguration<K, V> implements
    ClusteredCacheSharedConfiguration<K, V> {
  ...
  public BaseClusteredCacheSharedConfiguration(final Class<K> kClass, final Class<V> vClass) {
  ...
  public BaseClusteredCacheSharedConfiguration(final Class<K> kClass, final Class<V> vClass,
    ...
    this(kClass, vClass, evictionVeto, evictionPrioritizer, expiry, null, false,
        CacheLoaderWriter.NONE);
  }
  ...
  public BaseClusteredCacheSharedConfiguration(final Class<K> kClass, final Class<V> vClass,
      final EvictionVeto<? super K, ? super V> evictionVeto,
      final EvictionPrioritizer<? super K, ? super V> evictionPrioritizer,
      final Expiry<? super K, ? super V> expiry, final long size, final ResourceUnit unit,
      final boolean persistent, final boolean transactionalCache,
      final CacheLoaderWriter cacheLoaderWriter) {
    this(kClass, vClass, evictionVeto, evictionPrioritizer, expiry, null, transactionalCache,
        cacheLoaderWriter);
  ...
  public BaseClusteredCacheSharedConfiguration(final Class<K> kClass, final Class<V> vClass,
      final EvictionVeto<? super K, ? super V> evictionVeto,
      final EvictionPrioritizer<? super K, ? super V> evictionPrioritizer,
      final Expiry<? super K, ? super V> expiry, final ResourcePool resourcePool,
      final boolean transactionalCache, final CacheLoaderWriter cacheLoaderWriter) {
    this.kClass = kClass;
    this.vClass = vClass;
