 ...
 * @author Alex Snaps
 */
public class TerracottaBaseCacheConfiguration<K, V> extends BaseCacheConfiguration<K, V> implements
    TerracottaCacheConfiguration<K, V> {

  private ClusteredCacheSharedConfiguration<K, V> cacheSharedConfiguration;

  public TerracottaBaseCacheConfiguration(
      final ClusteredCacheSharedConfiguration<K, V> cacheSharedConfiguration,
      final ClassLoader classLoader, final ResourcePools resourcePools,
      final ServiceConfiguration<?>... serviceConfigurations) {
    super(cacheSharedConfiguration.getKeyType(), cacheSharedConfiguration.getValueType(),
        cacheSharedConfiguration.getEvictionVeto(), cacheSharedConfiguration
            .getEvictionPrioritizer(), classLoader, cacheSharedConfiguration.getExpiry(),
