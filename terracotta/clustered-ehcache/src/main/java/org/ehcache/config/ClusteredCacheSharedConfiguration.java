...
/**
 * todo: What do we do with these Class<K & V> here? Return String (variances?) or do we have a
 * ClassLoader available? todo: Further more, what can (EvictionVeto|EvictionPrioritizer|Expiry) be
 * UDTs when clustered?
 *
 * @author Alex Snaps
 */
